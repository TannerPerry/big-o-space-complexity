...
// ANSWER: The upper function already has an object with the letters, the lower function is creatint the object as it goes.
...
class Memoization {
  ...
  calcFib(num) {
    ...
    }else if (this.cache.hasOwnProperty(num)) {
      return this.cache[num]
    }
    let retVal = this.calcFib(num-1) + this.calcFib(num-2)
    this.cache[num] = retVal
    return retVal
...
function fib(num){
  ...
  let retVal = fib(num-1) + fib(num-2)
  return retVal
}
...
// ANSWER: I think it will be a noticeable difference

// Now fill this out and run your file

let fibSeq = new Memoization
